  ...
  [Language.TR]: {
    consent: {
      [ParticipantGroup.STANDARD]:
        "Bu çalışmaya katıldığınız için teşekkür ederiz. Çalışmaya katılım tamamen gönüllüdür. Çalışmayı dilediğiniz zaman sonlandırabilirsiniz; bunun için herhangi bir gerekçe göstermeniz gerekmez ve sizin için hiçbir olumsuz sonuç doğurmaz. <br><br> Bu anket yalnızca temel demografik bilgiler toplamaktadır. Yanıtlarınız yalnızca bilimsel amaçlarla toplanacak ve analiz edilecektir. Verileriniz güvenli bir şekilde saklanacak, gizli tutulacak ve yürürlükteki veri koruma düzenlemelerine uygun olarak işlenecektir. Kişisel verileriniz anonimleştirilecektir. Verileriniz anonimleştirildikten sonra artık kişisel olarak sizinle ilişkilendirilemez. Verilere yalnızca araştırma ekibi erişebilecektir. <br><br> Çalışmaya katılma ve verilerinizin kullanılmasına ilişkin onayınızı dilediğiniz zaman geri çekebilir ve verilerinizin silinmesini talep edebilirsiniz. Bu durumda verileriniz silinecek ve kullanılmayacaktır. <br><br> Çalışma hakkında sorularınız varsa lütfen şu kişiyle iletişime geçin: <br> Aylin Coşkun Kunduz, Konstanz Üniversitesi, aylin.coskun-kunduz@uni-konstanz.de <br><br> Katılımcı olarak haklarınızla ilgili endişeleriniz varsa Konstanz Üniversitesi Etik Kurulu (Ethik-Kommission der Universität Konstanz) ile iletişime geçebilirsiniz: <br> Universitätsstraße 10, 78464 Konstanz, Almanya, Tel.: +49 7531 88-5037, Faks: +49 7531 88-5039. Daha fazla bilgi için Etik Kurulu’nun web sayfasına bakabilirsiniz.",
      [ParticipantGroup.HERITAGE]:
        "Bu çalışmaya katıldığınız için teşekkür ederiz. Çalışmaya katılım tamamen gönüllüdür. Çalışmayı dilediğiniz zaman sonlandırabilir, dilediğiniz soruyu yanıtlamamayı tercih edebilirsiniz; bunun için herhangi bir gerekçe göstermeniz gerekmez ve sizin için hiçbir olumsuz sonuç doğurmaz. <br><br> Bu anket yalnızca temel demografik bilgiler toplamaktadır. Yanıtlarınız yalnızca bilimsel amaçlarla toplanacak ve analiz edilecektir. Verileriniz güvenli bir şekilde saklanacak, gizli tutulacak ve yürürlükteki veri koruma düzenlemelerine uygun olarak işlenecektir. Kişisel verileriniz anonimleştirilecektir. Verileriniz anonimleştirildikten sonra artık kişisel olarak sizinle ilişkilendirilemez. Verilere yalnızca araştırma ekibi erişebilecektir. <br><br> Çalışmaya katılma ve verilerinizin kullanılmasına ilişkin onayınızı dilediğiniz zaman geri çekebilirsiniz. Bu durumda verileriniz silinecek ve kullanılmayacaktır. <br><br> Çalışma hakkında sorularınız varsa lütfen şu kişiyle iletişime geçin: <br> İlkim Koç, Dilbilim Bölümü, Konstanz Üniversitesi, ilkim.koc@uni-konstanz.de <br><br> Katılımcı olarak haklarınızla ilgili endişeleriniz varsa Konstanz Üniversitesi Etik Kurulu (Ethik-Kommission der Universität Konstanz) ile iletişime geçebilirsiniz: <br> Universitätsstraße 10, 78464 Konstanz, Almanya, Tel.: +49 7531 88-5037, Faks: +49 7531 88-5039. Daha fazla bilgi için Etik Kurulu’nun web sayfasına bakabilirsiniz.",
      checkbox:
